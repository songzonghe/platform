...
/**
 * 问诊记录处方模板详情 service 实现类
 *  操作人： 曾晓
 */ 
@Service("utilPrescriptionDetailsServiceImp ")
public class UtilPrescriptionDetailsServiceImp implements UtilPrescriptionDetailsService {
	@Resource
	...
	private void getSQL(Map<String, String> mapStr,StringBuffer sql,Map<String, Object> mapSQLParameter) throws Exception {
		sql.append("select t.prescription_details_id,t.hospital_id,t.prescription_id,t.drug_id,t.details_consumption,t.details_frequency_str,t.details_frequency,t.details_day,t.details_num,t.details_usage,t.details_entrust,t.gxsj,t.bz,t.lrsj,t.zt,t.lrzh,p.prescription_name,d.drug_name");
		sql.append(" from util_prescription_details t, util_prescription p,util_drug d");
	...
	public Map<String, Object> add_Data(Map<String, String> mapStr) throws Exception{
		StringBuffer sql = new StringBuffer(); Map<String, Object> mapSQLParameter = new HashMap<String, Object>();
		sql.append("insert into util_prescription_details");
		...
		mapStr.put("prescription_details_id", this.gyDAOimp.exeSqlGetId(sql, mapSQLParameter));
	...
	public Map<String, Object> update_Data(Map<String, String> mapStr) throws Exception{
		...
		StringBuffer sql = new StringBuffer(); Map<String, Object> mapSQLParameter = new HashMap<String, Object>();
		sql.append("update util_prescription_details set gxsj=:gxsj");
		sql.append(" ,drug_id=:drug_id,details_consumption=:details_consumption,details_frequency_str=:details_frequency_str,details_frequency=:details_frequency,details_day=:details_day,details_num=:details_num,details_usage=:details_usage,details_entrust=:details_entrust, bz=:bz ");
	...
	public void delete_Data(Map<String, String> mapStr) throws Exception{
		StringBuffer sql = new StringBuffer(); Map<String, Object> mapSQLParameter = new HashMap<String, Object>();
		sql.append("delete from util_prescription_details where prescription_details_id=:prescription_details_id");
