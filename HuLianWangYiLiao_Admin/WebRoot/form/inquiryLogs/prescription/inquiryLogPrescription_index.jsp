		...
		<div class="row">
			...
			<div class="widget-header">
				<ul class="tab-list">
					...
					<li class="active" onclick="changeDataType('4')">问诊处方</li>
		...
		<table id="sample-table-1" class="table  table-bordered dataTable"> 
			<thead>
				<tr>
					...
					<th field="log_id"   onclick="querySort(this,'queryInquiryLogPrescription')"  >
						问诊记录
					</th>
					<th field="inquiry_patient_id"   onclick="querySort(this,'queryInquiryLogPrescription')"  >
						问诊患者
					</th>
					<th field="doctor_id"   onclick="querySort(this,'queryInquiryLogPrescription')"  >
						医生名字
					</th>
					<th field="prescription_type"   onclick="querySort(this,'queryInquiryLogPrescription')"  >
						处方类型
					</th>
					<th field="prescription_price"   onclick="querySort(this,'queryInquiryLogPrescription')"  >
						处方金额
					</th>
					<th field="gxsj" width="170" onclick="querySort(this,'queryInquiryLogPrescription')">
						修改时间
					</th>
				</tr>
			</thead>
