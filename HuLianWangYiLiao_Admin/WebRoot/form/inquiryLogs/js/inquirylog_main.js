...
function getUpdateMainJson(id) {
	...
	var update_log_type = $("#update_log_type").val();
	...
	var update_unprescribed_reasons = $("#update_unprescribed_reasons").val();
	var jsonObj = {
		...
		"unprescribed_reasons" : update_unprescribed_reasons,
		"log_id" : id
	};
