				...
				<div class="widget-box">
					...
					<div class="widget-body">
						<div class="widget-main no-padding">
							<form action="reportForm_dean_report_index.do?type=3" id="queryForm" method="post">
								<!-- 参数隐藏 用于页面传值-->
								<input style="display: none;" id="mapStr" name="mapStr">
		 						<fieldset>
									<label>时间</label>
									<input type="text" id="query_beginTime" placeholder="时间" value="${info.queryDate }" readonly="readonly" onclick="WdatePicker({dateFmt:'yyyy'})">
