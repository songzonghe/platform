				...
				<div class="widget-header">
					...
					<div class="widget-body">
						<div class="widget-main no-padding">
							<form action="utilCompany_index.do" id="queryForm" method="post">
								<!-- 参数隐藏 用于页面传值-->
								...
								<fieldset>
									...
									<input type="text" id="query_log_name" placeholder="厂家" value="${map.log_name}">
									<button type="submit" onclick="queryUtilCompany(0)" class="btn btn-sm btn-success">
										搜索
									...
									<button type="button" onclick="openImportBoxPage('util_company','queryUtilCompany')" class="btn btn-sm btn-info">
										导入
										<i class="ace-icon fa fa-plus icon-on-right bigger-110"></i>
									</button>
								</fieldset>
		...
		<table id="sample-table-1" class="table  table-bordered dataTable"> 
			<thead>
				<tr>
					...
					<th field="log_name"   onclick="querySort(this,'queryUtilCompany')"  >
						厂家
					</th>
					<th field="log_sort"  type="num"   onclick="querySort(this,'queryUtilCompany')"  >
						排序
					</th>
					<th field="gxsj" width="170" onclick="querySort(this,'queryUtilCompany')">
						修改时间
					</th>
					<th field="bz"  onclick="querySort(this,'queryUtilCompany')">
						备注
					</th>
					<th width="180">
						操作
...
<c:set var="cx" value="queryUtilCompany" />
...
<script src="${root}/form/util/company/js/utilcompany_main.js?<%=Math.random()%>"></script>
</body>
</html>