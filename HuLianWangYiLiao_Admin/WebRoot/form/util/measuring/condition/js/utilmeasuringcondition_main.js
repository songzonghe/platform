...
/************************系统生成方法开始******************************/
function queryUtilMeasuringCondition(page){
	loadingDiv();
	var query_hospital_id = $("#query_hospital_id").val();
	var query_condition_name = $("#query_condition_name").val();
	var json = {
		"hospital_id" : query_hospital_id,
		"condition_name" : query_condition_name,
 		 "condition_id" : ""
	 }	
...
function openAddPage(){
	var jsonAjax = {
		"url" : "utilMeasuringCondition_addPage.do",
		"jsonData" : null,
		"title" : "血糖测量条件 添加",
		"icon" : "plus",
...
function getUpdateMainJson(id) {
	...
	var update_condition_name = $("#update_condition_name").val();
	var update_condition_sort = $("#update_condition_sort").val();
	var jsonObj = {
		"hospital_id" : update_hospital_id,
		"condition_name" : update_condition_name,
		"condition_sort" : update_condition_sort,
		"condition_id" : id
	};
...
function addData(jsonObj){
	...
	var jsonAjax = {
		"url" : "utilMeasuringCondition_updateData.do",
		"jsonData" : jsonObj,
...
function openEditPage(id){
	var jsonObj = {"condition_id" : id};
	var jsonAjax = {
		"url" : "utilMeasuringCondition_editPage.do",
...
function confirmDeleteDate(id,name){
	...
	adminJS.confirm(jsonObj,function(e,id){
		...
		var jsonAjax = {
			'url' : 'utilMeasuringCondition_deleteData.do',
