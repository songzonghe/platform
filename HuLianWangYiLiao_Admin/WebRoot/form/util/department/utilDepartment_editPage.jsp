...
<div class="widget-main no-padding" style="width: 550px">
	<form class="form-horizontal" isValidate="y" onsubmit="return false;">
		...
		<div class="form-group field">
			...
			<div class="col-sm-5">
				<span class="block input-icon input-icon-right">
					<input type="text" placeholder="科室简介" id="update_department_ksjs" class="col-xs-12" data-validate="" value="${map.department_ksjs}" >
				</span>
			</div>
		</div>
		<div class="form-group field">
			...
			<div class="col-sm-5">
				<span class="block input-icon input-icon-right">
					<input type="text" placeholder="科室名称" id="update_department_name" class="col-xs-12" data-validate="" value="${map.department_name}" >
				</span>
			</div>
		</div>
		<div class="form-group field">
			...
			<div class="col-sm-5">
				<span class="block input-icon input-icon-right">
					<input type="text" placeholder="科室排序" id="update_department_sort" class="col-xs-12" data-validate="" value="${map.department_sort}" >
				</span>
			</div>
		</div>
		<div class="form-group field">
			...
			<div class="col-sm-5">
				<span class="block input-icon input-icon-right">
					<input type="text" placeholder="科室编码" id="update_department_ksmm" class="col-xs-12" data-validate="" value="${map.department_ksmm}" >
				</span>
			</div>
		</div>
		<div class="form-group field">
		...
		<div class="form-actions center">
			...
			<button type="submit" class="btn btn-sm btn-success" onclick="editDataValidate('${map.department_id}')">
				提交
