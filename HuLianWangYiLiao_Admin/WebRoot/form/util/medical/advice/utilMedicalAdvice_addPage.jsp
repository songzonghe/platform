		...
		<div class="form-group field">
			...
			<div class="col-sm-5">
				<span class="block input-icon input-icon-right">
					<input type="text" placeholder="医嘱名称" id="update_advice_name" class="col-xs-12" data-validate="required:医嘱名称不能为空哦！">
				</span>
			</div>
		</div>
		<div class="form-group field">
			...
			<div class="col-sm-5">
				<span class="block input-icon input-icon-right">
					<input type="text" placeholder="医嘱排序" id="update_advice_sort" class="col-xs-12" data-validate="required:医嘱排序不能为空哦！">
				</span>
			</div>
		</div>
