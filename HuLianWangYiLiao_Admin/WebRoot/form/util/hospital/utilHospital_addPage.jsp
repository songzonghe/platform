...
<div class="widget-main no-padding" style="width: 800px">
	<form class="form-horizontal" isValidate="y" onsubmit="return false;">
		...
		<div class="form-group">
			...
			<div class="col-sm-7 field">
				<span class="block input-icon input-icon-right">
					<input type="text" id="update_hospital_number" class="col-xs-12" data-validate="required:请输入账号！,ajax#utilHospital_findById.do?hospital_number=:账号已存在">
				</span>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-7 field">
				<span class="block input-icon input-icon-right">
					<input type="password"  id="update_hospital_pwd" name="hospital_pwd" class="col-xs-12" data-validate="required:请输入密码！" value="${map.hospital_pwd}" >
				</span>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-7 field">
				<span class="block input-icon input-icon-right">
					<input type="password" class="col-xs-12" data-validate="required:请输入确认密码！,repeat#hospital_pwd:两次输入的密码不一致">
				</span>
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-sm-7 field">
				<span class="block input-icon input-icon-right">
					<input type="text" id="update_hospital_xkzyxq" class="col-xs-12" data-validate="required:请输入许可证有效期！" readonly="readonly" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" value="${map.hospital_xkzyxq}">
				</span>
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-sm-7 field">
				<span class="block input-icon input-icon-right"> 
					...
					<input type="radio" name="update_hospital_jgszdmzzzdfbz" value="1" <c:if test="${map.hospital_jgszdmzzzdfbz=='1' }">checked="checked"</c:if>>是&nbsp;&nbsp;
				</span>
			</div>
		</div>
		<div class="form-group">
