				...
				<div class="widget-header">
					...
					<div class="widget-body">
						<div class="widget-main no-padding">
							<form action="utilIncompatibility_index.do" id="queryForm" method="post">
								<!-- 参数隐藏 用于页面传值-->
								...
								<fieldset>
									...
									<input type="text" id="query_drug_name" placeholder="" value="${map.drug_name}">
									<label>
										药品2
									</label>
									<input type="text" id="query_drug_name2" placeholder="" value="${map.drug_name2}">
									<button type="submit" onclick="queryUtilIncompatibility(0)" class="btn btn-sm btn-success">
										搜索
		...
		<table id="sample-table-1" class="table  table-bordered dataTable"> 
			<thead>
				<tr>
					...
					<th field="drug_id"   onclick="querySort(this,'queryUtilIncompatibility')"  >
						药品
					</th>
					<th field="drug_id2"   onclick="querySort(this,'queryUtilIncompatibility')"  >
						药品2
					</th>
					<th field="gxsj" width="170" onclick="querySort(this,'queryUtilIncompatibility')">
						修改时间
					</th>
					<th field="bz"  onclick="querySort(this,'queryUtilIncompatibility')">
						备注
					</th>
					<th width="180">
						操作
			...
			<tbody id="tbodyData">
				...
				<c:forEach items="${listMap}" varStatus="i" var="info">
					<tr id="tr${info.incompatibility_id}">
						...
						<td style="vertical-align: middle;">
							<button class="btn btn-xs btn-info" onclick="openEditPage('${info.incompatibility_id}')" title="编辑">
								编辑
							</button>
							<button class="btn btn-xs btn-danger" onclick="confirmDeleteDate('${info.incompatibility_id}','${info.incompatibility_id}')" title="删除">
								删除
							</button>
						</td>
					</tr>
...
<c:set var="cx" value="queryUtilIncompatibility" />
...
<script src="${root}/form/util/incompatibility/js/utilincompatibility_main.js?<%=Math.random()%>"></script>
</body>
</html>