...
/************************系统生成方法开始******************************/
function queryUtilSpecification(page){
	loadingDiv();
	var query_hospital_id = $("#query_hospital_id").val();
	var query_specification_name = $("#query_specification_name").val();
	var json = {
		"hospital_id" : query_hospital_id,
		"specification_name" : query_specification_name,
 		 "specification_id" : ""
	 }	
...
function openAddPage(){
	var jsonAjax = {
		"url" : "utilSpecification_addPage.do",
		"jsonData" : null,
		"title" : "问诊规范添加",
		"icon" : "plus",
...
function getUpdateMainJson(id) {
	...
	var update_specification_name = $("#update_specification_name").val();
	var update_specification_details = $("#update_specification_details").val();
	var update_specification_sort = $("#update_specification_sort").val();
	var jsonObj = {
		"hospital_id" : update_hospital_id,
		"specification_name" : update_specification_name,
		"specification_details" : update_specification_details,
		"specification_sort" : update_specification_sort,
		"specification_id" : id
	};
...
function addData(jsonObj){
	...
	var jsonAjax = {
		"url" : "utilSpecification_updateData.do",
		"jsonData" : jsonObj,
...
function openEditPage(id){
	var jsonObj = {"specification_id" : id};
	var jsonAjax = {
		"url" : "utilSpecification_editPage.do",
...
function confirmDeleteDate(id,name){
	...
	adminJS.confirm(jsonObj,function(e,id){
		...
		var jsonAjax = {
			'url' : 'utilSpecification_deleteData.do',
