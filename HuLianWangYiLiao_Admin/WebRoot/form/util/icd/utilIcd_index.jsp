				...
				<div class="widget-header">
					...
					<div class="widget-body">
						<div class="widget-main no-padding">
							<form action="utilIcd_index.do" id="queryForm" method="post">
								<!-- 参数隐藏 用于页面传值-->
								...
								<fieldset>
									...
									<button type="submit" onclick="queryUtilIcd(0)" class="btn btn-sm btn-success">
										搜索
		...
		<table id="sample-table-1" class="table  table-bordered dataTable"> 
			<thead>
				<tr>
					...
					<th field="icd_name"   onclick="querySort(this,'queryUtilIcd')"  >
						分类名称
					</th>
					<th field="icd_sort"  type="num"   onclick="querySort(this,'queryUtilIcd')"  >
						分类排序
					</th>
					<th field="gxsj" width="170" onclick="querySort(this,'queryUtilIcd')">
						修改时间
					</th>
					<th field="bz"  onclick="querySort(this,'queryUtilIcd')">
						备注
					</th>
					<th width="180">
						操作
			...
			<tbody id="tbodyData">
				...
				<c:forEach items="${listMap}" varStatus="i" var="info">
					<tr id="tr${info.icd_id}">
						...
						<td style="vertical-align: middle;">
							<button class="btn btn-xs btn-info" onclick="openEditPage('${info.icd_id}')" title="编辑">
								编辑
							</button>
							<button class="btn btn-xs btn-danger" onclick="confirmDeleteDate('${info.icd_id}','${info.icd_id}')" title="删除">
								删除
							</button>
						</td>
					</tr>
...
<c:set var="cx" value="queryUtilIcd" />
...
<script src="${root}/form/util/icd/js/utilicd_main.js?<%=Math.random()%>"></script>
</body>
</html>