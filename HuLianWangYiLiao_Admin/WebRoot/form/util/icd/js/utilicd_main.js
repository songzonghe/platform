...
function getUpdateMainJson(id) {
	var update_icd_name = $("#update_icd_name").val();
	var update_icd_sort = $("#update_icd_sort").val();
	var jsonObj = {
		"icd_name" : update_icd_name,
		"icd_sort" : update_icd_sort,
		"icd_id" : id
	};
...
function openEditPage(id){
	var jsonObj = {"icd_id" : id};
	var jsonAjax = {
		"url" : "utilIcd_editPage.do",
