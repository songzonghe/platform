		...
		<div class="row">
			...
			<div class="widget-header">
				<ul class="tab-list">
					...
					<li class="active" onclick="changeDataType('3')">检查单详情</li>
		...
		<table id="sample-table-1" class="table  table-bordered dataTable"> 
			<thead>
				<tr>
					...
					<th field="checklist_type"   onclick="querySort(this,'queryInquiryLogHealthGuidance')"  >
						检查单号
					</th>
					<th field="checklist_type"   onclick="querySort(this,'queryInquiryLogHealthGuidance')"  >
						检查类型
					</th>
					<th field="checklist_name"   onclick="querySort(this,'queryInquiryLogHealthGuidance')"  >
						检查名称
					</th>
