				...
				<div class="widget-header">
					...
					<div class="widget-body">
						<div class="widget-main no-padding">
							<form action="utilUnprescribedReasons_index.do" id="queryForm" method="post">
								<!-- 参数隐藏 用于页面传值-->
								...
								<fieldset>
									...
									<input type="text" id="query_reasons_name" placeholder="原因名称" value="${map.reasons_name}">
									<button type="submit" onclick="queryUtilUnprescribedReasons(0)" class="btn btn-sm btn-success">
										搜索
		...
		<table id="sample-table-1" class="table  table-bordered dataTable"> 
			<thead>
				<tr>
					...
					<th field="reasons_name"   onclick="querySort(this,'queryUtilUnprescribedReasons')"  >
						原因名称
					</th>
					<th field="reasons_sort"   onclick="querySort(this,'queryUtilUnprescribedReasons')"  >
						原因排序
					</th>
					<th field="gxsj" width="170" onclick="querySort(this,'queryUtilUnprescribedReasons')">
						修改时间
					</th>
					<th field="bz"  onclick="querySort(this,'queryUtilUnprescribedReasons')">
						备注
					</th>
					<th width="180">
						操作
			...
			<tbody id="tbodyData">
				...
				<c:forEach items="${listMap}" varStatus="i" var="info">
					<tr id="tr${info.reasons_id}">
						...
						<td style="vertical-align: middle;">
							<button class="btn btn-xs btn-info" onclick="openEditPage('${info.reasons_id}')" title="编辑">
								编辑
							</button>
							<button class="btn btn-xs btn-danger" onclick="confirmDeleteDate('${info.reasons_id}','${info.reasons_id}')" title="删除">
								删除
							</button>
						</td>
					</tr>
...
<c:set var="cx" value="queryUtilUnprescribedReasons" />
...
<script src="${root}/form/util/unprescribed/reasons/js/utilunprescribedreasons_main.js?<%=Math.random()%>"></script>
</body>
</html>