...
/************************系统生成方法开始******************************/
function queryInquiryLogImg(page){
	loadingDiv();
	var query_log_id = $("#query_log_id").val();
	var query_img_src = $("#query_img_src").val();
	var json = {
		"log_id" : query_log_id,
		"img_src" : query_img_src,
 		 "img_id" : ""
	 }	
...
function getUpdateMainJson(id) {
	...
	var update_img_src = $("#update_img_src").attr("src");
	var jsonObj = {
		"hospital_id" : update_hospital_id,
		"log_id" : update_log_id,
		"img_src" : update_img_src,
		"img_id" : id
	};
...
function addData(jsonObj){
	...
	var jsonAjax = {
		"url" : "inquiryLogImg_updateData.do",
		"jsonData" : jsonObj,
...
function openEditPage(id){
	var jsonObj = {"img_id" : id};
	var jsonAjax = {
		"url" : "inquiryLogImg_editPage.do",
...
function confirmDeleteDate(id,name){
	...
	adminJS.confirm(jsonObj,function(e,id){
		...
		var jsonAjax = {
			'url' : 'inquiryLogImg_deleteData.do',
