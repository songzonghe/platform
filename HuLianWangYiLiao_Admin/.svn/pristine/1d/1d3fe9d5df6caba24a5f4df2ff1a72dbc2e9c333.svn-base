...
<div class="widget-main no-padding" style="width: 800px">
	<form class="form-horizontal" isValidate="y" onsubmit="return false;">
		...
		<div class="form-group">
			...
			<div class="col-sm-7 field">
				<span class="block input-icon input-icon-right">
					<input type="text" placeholder="账号" id="update_store_phone" class="col-xs-12" data-validate="required:门店账号不能为空哦！,ajax#storeInfo_findById.do?store_phone=:账号已存在" >
				</span>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-7 field">
				<span class="block input-icon input-icon-right">
					<input type="password" placeholder="密码" id="update_store_paw" name="store_paw" class="col-xs-12" data-validate="required:门店密码不能为空哦！" value="" >
				</span>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-7 field">
				<span class="block input-icon input-icon-right">
					<input type="password" placeholder="确认密码" id="store_paw" class="col-xs-12" data-validate="required:确认密码不能为空哦！,repeat#store_paw:两次输入的密码不一致" value="" >
				</span>
			</div>
		</div>
			...
			<div class="col-sm-7 field">
				<span class="block input-icon input-icon-right">
					<select id="update_store_fwdlx" class="col-xs-12" >
						...
						<option value="01" <c:if test="${store_fwdlx=='01'}">selected="selected"</c:if>>互联网医院诊疗</option>
						<option value="02" <c:if test="${store_fwdlx=='02'}">selected="selected"</c:if>>健康管理服务</option>
						<option value="03" <c:if test="${store_fwdlx=='03'}">selected="selected"</c:if>>药事服务机构</option>
						<option value="04" <c:if test="${store_fwdlx=='04'}">selected="selected"</c:if>>药房</option>
						<option value="05" <c:if test="${store_fwdlx=='05'}">selected="selected"</c:if>>社区中心</option>
						<option value="06" <c:if test="${store_fwdlx=='06'}">selected="selected"</c:if>>其他</option>
					</select>
				</span>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-7 field">
				<span class="block input-icon input-icon-right">
					<select id="update_store_fwdflgllbdm" class="col-xs-12" data-validate="required:不能为空哦！">
						<option value="">请选择</option>
		...
		<div class="form-group">
			...
			<div class="col-sm-7 field">
				<span class="block input-icon input-icon-right">
					<select id="update_store_jjlxdm" class="col-xs-12" data-validate="required:不能为空哦！">
						<option value="">请选择</option>
						<c:forEach var="datas" items="${allList.list008}">
							<option value="${datas.code}" <c:if test="${map.store_jjlxdm==datas.code}">selected="selected"</c:if>>${datas.name}</option>
						</c:forEach>
					</select>
				</span>
			</div>
