...
<div class="widget-main no-padding" style="width: 550px">
	<form class="form-horizontal" isValidate="y" onsubmit="return false;">
		...
		<div class="form-group field">
			...
			<div class="col-sm-5">
				<span class="block input-icon input-icon-right">
					<input type="text" placeholder="原医生名字" id="update_old_doctor_id" class="col-xs-12" data-validate="required:原医生名字不能为空哦！" value="${map.old_doctor_id}" >
				</span>
			</div>
		</div>
		<div class="form-group field">
		...
		<div class="form-actions center">
			...
			<button type="submit" class="btn btn-sm btn-success" onclick="editDataValidate('${map.note_id}')">
				提交
