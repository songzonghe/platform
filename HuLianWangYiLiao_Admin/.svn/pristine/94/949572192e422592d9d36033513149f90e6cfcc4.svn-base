...
<div class="widget-main no-padding" style="width: 100%;height:100%;overflow-y: auto;">
	<form class="form-horizontal" isValidate="y" onsubmit="return false;">
		...
		<div class="form-group">
			...
			<div class="col-sm-7 field">
				<span class="block input-icon input-icon-right">
					...
					<input type="radio" <c:if test="${map.hospital_styljgjb=='2' }">checked="checked"</c:if>  name="update_hospital_styljgjb" value="2">一级医院&nbsp;&nbsp;
					<input type="radio" <c:if test="${map.hospital_styljgjb=='3' }">checked="checked"</c:if>  name="update_hospital_styljgjb" value="3">一级医院&nbsp;&nbsp;
		...
		<div class="form-actions center">
			<button type="submit" class="btn btn-sm btn-success" onclick="editDataValidate('${map.hospital_id}','shop')">
				保存
			</button>
		</div>
	</form>
