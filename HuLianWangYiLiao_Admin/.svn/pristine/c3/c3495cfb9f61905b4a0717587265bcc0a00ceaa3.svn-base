...
<div class="widget-main no-padding" style="width: 550px">
	<form class="form-horizontal" isValidate="y" onsubmit="return false;">
		...
		<div class="form-group field">
			...
			<div class="col-sm-5">
				<span class="block input-icon input-icon-right">
					<input type="text" placeholder="指导名称" id="update_guidance_name" class="col-xs-12" data-validate="required:指导名称不能为空哦！"  value="${map.guidance_name}" >
				</span>
			</div>
		</div>
		<div class="form-group field">
			...
			<div class="col-sm-5">
				<span class="block input-icon input-icon-right">
					<input type="text" placeholder="指导内容" id="update_guidance_content" class="col-xs-12" data-validate="required:指导内容不能为空哦！" value="${map.guidance_content}" >
				</span>
			</div>
		</div>
		...
		<div class="form-actions center">
			...
			<button type="submit" class="btn btn-sm btn-success" onclick="editDataValidate('${map.guidance_id}')">
				提交
