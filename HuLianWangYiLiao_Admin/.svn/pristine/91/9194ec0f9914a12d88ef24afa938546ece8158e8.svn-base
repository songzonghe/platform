...
/************************系统生成方法开始******************************/
function queryUtilCertificates(page){
	loadingDiv();
	var query_certificates_number = $("#query_certificates_number").val();
	var json = {
		"certificates_number" : query_certificates_number,
 		 "certificates_id" : ""
	 }	
...
function openAddPage(){
	var jsonAjax = {
		"url" : "utilCertificates_addPage.do",
		"jsonData" : null,
		"title" : "系统初始化证件添加",
		"icon" : "plus",
...
function getUpdateMainJson(id) {
	var update_certificates_number = $("#update_certificates_number").val();
	var update_certificates_name = $("#update_certificates_name").val();
	var update_certificates_sort = $("#update_certificates_sort").val();
	var jsonObj = {
		"certificates_number" : update_certificates_number,
		"certificates_name" : update_certificates_name,
		"certificates_sort" : update_certificates_sort,
		"certificates_id" : id
	};
...
function addData(jsonObj){
	...
	var jsonAjax = {
		"url" : "utilCertificates_updateData.do",
		"jsonData" : jsonObj,
...
function openEditPage(id){
	var jsonObj = {"certificates_id" : id};
	var jsonAjax = {
		"url" : "utilCertificates_editPage.do",
...
function confirmDeleteDate(id,name){
	...
	adminJS.confirm(jsonObj,function(e,id){
		...
		var jsonAjax = {
			'url' : 'utilCertificates_deleteData.do',
