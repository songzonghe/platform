...
<div class="widget-main no-padding" style="width: 550px">
	<form class="form-horizontal" isValidate="y" onsubmit="return false;">
		...
		<div class="form-group field">
			...
			<div class="col-sm-5">
				<span class="block input-icon input-icon-right">
					<input type="text" placeholder="模板名称" id="update_template_name" class="col-xs-12" data-validate="required:模板名称不能为空哦！" value="${map.template_name}" >
				</span>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-5">
				<span class="block input-icon input-icon-right">
					<textarea class="col-xs-12" id="update_template_details" placeholder="模板内容" >${map.template_details}</textarea>
				</span>
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-actions center">
			...
			<button type="submit" class="btn btn-sm btn-success" onclick="editDataValidate('${map.template_id}')">
				提交
