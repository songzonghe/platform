		...
		<div class="form-group field">
			...
			<div class="col-sm-5">
				<span class="block input-icon input-icon-right">
					<input type="text" placeholder="职称名称" id="update_title_name" class="col-xs-12" data-validate="required:职称名称不能为空哦！">
				</span>
			</div>
		</div>
		<div class="form-group field">
			...
			<div class="col-sm-5">
				<span class="block input-icon input-icon-right">
					<input type="text" placeholder="排序" id="update_title_sort" class="col-xs-12" data-validate="required:排序不能为空哦！">
				</span>
			</div>
		</div>
